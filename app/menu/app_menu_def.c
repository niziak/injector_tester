...
const MENU_ITEM_DEF	atdMenuItems[NUMBER_OF_MENU_ITEMS] =
{
        { LVL0, MID_INVALID,        "Tryb",                     MENU_FN_CHILD_MENU,                         NO_ASK  },
            ...
            { LVL1, MID_INVALID,            "Auto 1 PIR",           0,                                      NO_ASK  },
            { LVL1, MID_INVALID,            "Auto 2",               0,                                      NO_ASK  },
            { LVL1, MID_INVALID,            "Auto 3",               0,                                      NO_ASK  },
            { LVL1, MID_INVALID,            "Auto 4",               0,                                      NO_ASK  },
		...
		{ LVL0, MID_SETTINGS,		"Ustawienia",              MENU_FN_CHILD_MENU,	                        NO_ASK	},
			...
			{ LVL1, MID_INVALID,			"Zegar",		    MENU_FN_SET_CLOCK,                          ASK	    },
