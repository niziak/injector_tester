...
const MENU_ITEM_DEF	atdMenuItems[NUMBER_OF_MENU_ITEMS] =
{
        { LVL0, MID_NA,        "Tryb",                     MENU_FN_CHILD_MENU,                         NO_ASK                        },
            ...
            { LVL1, MID_NA,            "A1 PIR",               MENU_FN_APP_MODE_AUTO_1,                                      NO_ASK  },
            { LVL1, MID_NA,            "A2 PIR+Czas",          MENU_FN_APP_MODE_AUTO_2,                                      NO_ASK  },
            { LVL1, MID_NA,            "A3 PIR+Czas",          MENU_FN_APP_MODE_AUTO_3,                                      NO_ASK  },
            { LVL1, MID_NA,            "A4",                   MENU_FN_APP_MODE_AUTO_4,                                      NO_ASK  },
            { LVL1, MID_NA,            "A5",                   MENU_FN_APP_MODE_AUTO_5,                                      NO_ASK  },
		...
		{ LVL0, MID_SETTINGS,		"Ustawienia",              MENU_FN_CHILD_MENU,	                        NO_ASK	                 },
            ...
            { LVL1, MID_NA,            "A2 PIR+Czas",          MENU_FN_SETTINGS_AUTO_2,                NO_ASK                        },
            { LVL1, MID_NA,            "A3 PIR+Czas",          MENU_FN_SETTINGS_AUTO_3,                NO_ASK                        },
            { LVL1, MID_NA,            "A4",                   MENU_FN_SETTINGS_AUTO_4,                NO_ASK                        },
            { LVL1, MID_NA,            "A5",                   MENU_FN_SETTINGS_AUTO_5,                NO_ASK                        },
            ...
            { LVL1, MID_NA,             "Czas podsw.",          MENU_FN_CHILD_MENU,                      NO_ASK      },
                { LVL2, MID_BL_ADJ,     0,                       MENU_FN_UNDEF,                               ASK    },
