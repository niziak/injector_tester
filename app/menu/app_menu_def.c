...
const MENU_ITEM_DEF	atdMenuItems[NUMBER_OF_MENU_ITEMS] =
{
        { LVL0, MID_NA,        "Tryb",                     MENU_FN_CHILD_MENU,                         NO_ASK                        },
            ...
            { LVL1, MID_NA,            "Auto 2 PIR+Czas",      MENU_FN_APP_MODE_AUTO_2,                                      NO_ASK  },
            { LVL1, MID_NA,            "Auto 3 PIR+Czas",      MENU_FN_APP_MODE_AUTO_3,                                      NO_ASK  },
            { LVL1, MID_NA,            "Auto 4",               MENU_FN_APP_MODE_AUTO_4,                                      NO_ASK  },
            { LVL1, MID_NA,            "Auto 5",               MENU_FN_APP_MODE_AUTO_5,                                      NO_ASK  },
		...
		{ LVL0, MID_SETTINGS,		"Ustawienia",              MENU_FN_CHILD_MENU,	                        NO_ASK	                 },
            ...
            { LVL1, MID_NA,            "Auto 5",               MENU_FN_SETTINGS_AUTO_5,                NO_ASK                        },
