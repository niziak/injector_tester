...
#define DEBUG_T(format, string...)      {LOG_Log_P(PSTR("[%5ul] "),ulSystemTickS);     LOG_Log(format, ##string);}
#define DEBUG_P(format, string...)      {                                           LOG_Log_P(format, ##string);}
#define DEBUG_T_P(format, string...)    {LOG_Log_P(PSTR("[%5ul] "),ulSystemTickS);     LOG_Log_P(format, ##string);}
